...
## extends HttpRouter
##
## func handle_get(request: HttpRequest, response: GodottpdResponse) -> void:
...
var handle_get: Callable = func(request: HttpRequest, response: GodottpdResponse) -> bool:
	#response.send(405, "GET not allowed")
	return false
	
var handle_post: Callable = func(request: HttpRequest, response: GodottpdResponse) -> bool:
	#response.send(405, "POST not allowed")
	return false

var handle_head: Callable = func(request: HttpRequest, response: GodottpdResponse) -> bool:
	#response.send(405, "POST not allowed")
	return false
	
var handle_put: Callable = func(request: HttpRequest, response: GodottpdResponse) -> bool:
	#response.send(405, "POST not allowed")
	return false

var handle_patch: Callable = func(request: HttpRequest, response: GodottpdResponse) -> bool:
	#response.send(405, "POST not allowed")
	return false

var handle_delete: Callable = func(request: HttpRequest, response: GodottpdResponse) ->  bool:
	#response.send(405, "POST not allowed")
	return false

var handle_options: Callable = func(request: HttpRequest, response: GodottpdResponse) -> bool:
	#response.send(405, "POST not allowed")
	return false
...
### [br][param response] - The node to send the response back to the client
#@warning_ignore("unused_parameter")
#func handle_post(request: HttpRequest, response: GodottpdResponse) -> void:
	#response.send(405, "POST not allowed")
#
#
...
### [br][param response] - The node to send the response back to the client
#@warning_ignore("unused_parameter")
#func handle_head(request: HttpRequest, response: GodottpdResponse) -> void:
...
### [br][param response] - The node to send the response back to the client
#@warning_ignore("unused_parameter")
#func handle_put(request: HttpRequest, response: GodottpdResponse) -> void:
...
### [br][param response] - The node to send the response back to the client
#@warning_ignore("unused_parameter")
#func handle_patch(request: HttpRequest, response: GodottpdResponse) -> void:
...
### [br][param response] - The node to send the response back to the client
#@warning_ignore("unused_parameter")
#func handle_delete(request: HttpRequest, response: GodottpdResponse) -> void:
...
### [br][param response] - The node to send the response back to the client
#@warning_ignore("unused_parameter")
#func handle_options(request: HttpRequest, response: GodottpdResponse) -> void:
