...
**SUBSYSTEM DEPENDENCIES** - VR systems depend on Physics, which depends on Floating Origin. Audio depends on VR for spatial audio. FractalZoom and CaptureEvent depend on core systems.
